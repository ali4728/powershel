...
##
  ...
  $machines = "DESKTOP10" # fake an array of machines to process
...
##
  ...
  Get-Counter -ComputerName $env:COMPUTERNAME -ListSet 'MSSQLSERVER$SQL14*' |
...
"@
  ...
  Get-WmiObject -ComputerName "DESKTOP10" -Query $wmiQuery 
